...
const meta = {
  ...
  args: {
    ...
    traffic: { success: 148_000, failure: 300, total: 148_300, observed: true, versionAttributed: false },
  },
...
export const NotObservedAtAll: Story = {
  args: {
    ...
    traffic: { success: 0, failure: 0, total: 0, observed: false, versionAttributed: false },
  },
};
